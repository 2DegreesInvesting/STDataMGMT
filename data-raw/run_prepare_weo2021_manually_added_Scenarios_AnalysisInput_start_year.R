...
# scenario_input_p4i_weo2021 <- read.csv
# ("~/Dropbox (2° Investing)/PortCheck/00_Data/01_ProcessedData/03_ScenarioData/scenario_input_p4i_weo2021.csv")
# 
# Scenarios_AnalysisInput_2021 <- read.csv
# ("~/Dropbox (2° Investing)/PortCheck/00_Data/01_ProcessedData/03_ScenarioData/Scenarios_AnalysisInput_2021.csv")
# 
...
#           "~/Dropbox (2° Investing)/PortCheck/00_Data/01_ProcessedData/03_ScenarioData/
#           weo2021_manually_added_Scenarios_AnalysisInput_2021.csv", row.names = FALSE)
