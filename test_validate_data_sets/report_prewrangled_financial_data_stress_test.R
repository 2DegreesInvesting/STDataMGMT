...
plan_prewrangled_financial_data_stress_test <- agent_prewrangled_financial_data_stress_test |>
  col_vals_not_null(columns = c("company_name",
                                "company_id",
                                "pd",
                                "net_profit_margin",
                                "debt_equity_ratio",
  ...
  col_is_numeric(columns = c("company_id",
                             "pd",
                             "net_profit_margin",
                             "debt_equity_ratio",
                             "volatility")
  ) |>
  col_is_character(columns = c("company_name",
                             "corporate_bond_ticker")              
                 
  ) |>
  rows_distinct(columns = c("company_name",
                            "company_id",
                            "corporate_bond_ticker"
  ))
