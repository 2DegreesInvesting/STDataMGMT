...
plan_agent_scenario_analysisinput <- agent_scenario_analysisinput |>
  col_vals_not_null(columns = c("scenario_geography",
                                "scenario",
                                "ald_sector",
                                "units",
                                "technology",
  ...
  col_is_numeric(columns = c("fair_share_perc",
                             "year")
  ) |>
  
  col_is_character(columns = c("scenario_geography",
                               "ald_sector",
                               "scenario",
                               "units",
                               "technology",
  ...
  rows_distinct(columns = c("scenario",
                            "scenario_geography",
                            "year",
                            "ald_sector",
                            "technology",
...
plan_agent_scenario_analysisinput |>
  interrogate() |> export_report(filename =  affix_datetime(
